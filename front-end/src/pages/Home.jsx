        ...
        <div>
            <section id="hotel-hero" className="hotel-hero section">
                <div className="container">
                    {/* <!-- HERO MAIN (texte + image alignés verticalement) --> */}
                    <div
                        className="hero-main"
                        data-aos="fade-up"
                        data-aos-delay="100"
                                    ...
                                    >
                                        <div className="card-content">
                                            ...
                                            <p>
                                                ...
                                                service was impeccable and the
                                                views breathtaking."
                                            </p>
                    ...
                    <div className="row gy-4 align-items-center">
                        ...
                        >
                            <div className="about-content">
                                ...
                                <p className="lead">
                                    Where luxury meets tranquility in the heart
                                    of nature's paradise.
                                </p>
                                <p>
                                    Nestled among rolling hills and pristine
                                    landscapes, Grandview Resort has been
                                    offering exceptional hospitality for over
                                    three decades. Our commitment to excellence
                                    and attention to detail creates an
                                    unforgettable experience for discerning
                                    travelers seeking both comfort and
                                    adventure.
                                </p>
                                <p>
                                    From our elegantly appointed suites to our
                                    world-className amenities, every aspect of
                                    your stay is designed to exceed
                                    expectations. Discover breathtaking views,
                            ...
                            <div className="facility-card">
                                ...
                                <div className="facility-info">
                                    ...
                                    <p>
                                        ...
                                        throughout the hotel premises with
                                        enterprise-grade security and unlimited
                                        bandwidth for all your connectivity
                                        needs.
                                    </p>
                            ...
                            <div className="facility-card">
                                ...
                                <div className="facility-info">
                                    ...
                                    <p>
                                        ...
                                        Features heated water, poolside service,
                                        and premium lounging areas for ultimate
                                        relaxation.
                                    </p>
                                    <div className="facility-features">
                                        <span>
                        ...
                        >
                            <div className="facility-card">
                                ...
                                <div className="facility-info">
                                    ...
                                    <p>
                                        Cutting-edge fitness facility featuring
                                        premium equipment, personal training
                                        services, and wellness programs designed
                                        to maintain your health routine while
                                        traveling.
                                    </p>
                                    <div className="facility-features">
                                        <span>
                            ...
                            <div className="facility-card">
                                ...
                                <div className="facility-info">
                                    ...
                                    <p>
                                        ...
                                        featuring international cuisine crafted
                                        by renowned chefs. Elegant atmosphere
                                        with extensive wine selection and
                                        impeccable service.
                                    </p>
                                    <div className="facility-features">
                                        <span>
                        ...
                        >
                            <div className="facility-card">
                                ...
                                <div className="facility-info">
                                    <h4>Luxury Spa</h4>
                                    <p>
                                        Tranquil sanctuary offering therapeutic
                                        treatments, rejuvenating massages, and
                                        holistic wellness experiences. Escape
                                        the everyday stress in our serene
                                        environment.
                                    </p>
                                    <div className="facility-features">
                                        <span>
                                ...
                                <div className="testimonial-card">
                                    ...
                                    <div className="testimonial-content">
                                        <p>
                                            ...
                                            mattis, pulvinar dapibus leo. Sed
                        ...
                        <div className="col-lg-4 col-md-6">
                            ...
                            >
                                ...
                                <div className="offer-content">
                                    ...
                                    <p>
                                        Escape the ordinary with our exclusive
                                        weekend package. Includes complimentary
                                        breakfast and late checkout until 2 PM.
                                    </p>
                        ...
                        <div className="col-lg-4 col-md-6">
                            ...
                            >
                                ...
                                <div className="offer-content">
                                    ...
                                    <p>
                                        Plan ahead and save more! Book your stay
                                        30 days in advance and enjoy exclusive
                                        rates with free cancellation up to 7
                                        days.
                                    </p>
                                    <div className="offer-details">
                                        <div className="price-info">
                    ...
                    <div className="row align-items-center">
                        ...
                        >
                            <div className="content">
                                ...
                                <p>
                                    Immerse yourself in unparalleled comfort and
                                    sophistication at our premium hotel. From
                                    elegantly appointed rooms to world-className
                                    amenities, every detail is crafted to exceed
                                    your expectations. Book your extraordinary
                                    stay today and create unforgettable
                                    memories.
                                </p>
                            ...
                            <div className="location-overview">
                                <div className="overview-header">
                                    ...
                                    <p className="overview-subtitle">
                                        Maecenas faucibus mollis interdum. Nulla

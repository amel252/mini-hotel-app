...
export default function Home() {
    return (
        <div className="index-page">
            <div className="main">
                <div id="hotel-hero" className="hotel-hero section">
                    <div
                        className="container"
                        data-aos="fade-up"
                        data-aos-delay="100"
                            ...
                            <div className="col-lg-6">
                                <div className="hero-content">
                                    ...
                                    >
                                        ...
                                        sophistication at our premium hotel.
                                        From elegant suites to world-className
                                        amenities, every moment of your stay is
                        ...
                        <div className="row gy-4 align-items-center">
                            ...
                            >
                                <div className="about-content">
                                    ...
                                    <p className="lead">
                                        Where luxury meets tranquility in the
                                        heart of nature's paradise.
                                    </p>
                                    <p>
                                        Nestled among rolling hills and pristine
                                        landscapes, Grandview Resort has been
                                        offering exceptional hospitality for
                                        over three decades. Our commitment to
                                        excellence and attention to detail
                                        creates an unforgettable experience for
                                        discerning travelers seeking both
                                        comfort and adventure.
                                    </p>
                                    <p>
                                        From our elegantly appointed suites to
                                        our world-className amenities, every
                                        aspect of your stay is designed to
                                        exceed expectations. Discover
                                        breathtaking views, exquisite dining,
                                        and personalized service that makes
                                    ...
                                    >
                                        ...
                                        <div className="card-content">
                                            ...
                                            <p>
                                                ...
                                                necessitatibus saepe eveniet ut
                                                et voluptates.
                                            </p>
                                            <div className="features-list">
                                                <span>
                ...
                <section
                    id="amenities-cards"
                    className="amenities-cards section"
                >
                    <div className="container section-title" data-aos="fade-up">
                                ...
                                <div className="facility-card">
                                    ...
                                    <div className="facility-info">
                                        ...
                                        <p>
                                            ...
                                            access throughout the hotel premises
                                            with enterprise-grade security and
                                            unlimited bandwidth for all your
                                            connectivity needs.
                                        </p>
                            ...
                            >
                                <div className="facility-card">
                                    ...
                                    <div className="facility-info">
                                        <h4>Rooftop Pool</h4>
                                        <p>
                                            Luxurious rooftop swimming pool with
                                            breathtaking city skyline views.
                                            Features heated water, poolside
                                            service, and premium lounging areas
                            ...
                            >
                                <div className="facility-card">
                                    ...
                                    <div className="facility-info">
                                        <h4>Valet Parking</h4>
                                        <p>
                                            Premium valet parking service with
                                            secure underground facility.
                                            Professional attendants ensure your
                                            vehicle is safely parked and readily
                                ...
                                <div className="facility-card">
                                    ...
                                    <div className="facility-info">
                                        ...
                                        <p>
                                            ...
                                            featuring premium equipment,
                                            personal training services, and
                                            wellness programs designed to
                                            maintain your health routine while
                                            traveling.
                                        </p>
                                        <div className="facility-features">
                                            <span>
                                ...
                                <div className="facility-card">
                                    ...
                                    <div className="facility-info">
                                        ...
                                        <p>
                                            ...
                                            crafted by renowned chefs. Elegant
                                            atmosphere with extensive wine
                                            selection and impeccable service.
                                        </p>
                                        <div className="facility-features">
                                            <span>
                                                <i className="bi bi-check-circle"></i>{" "}
                            ...
                            >
                                <div className="facility-card">
                                    ...
                                    <div className="facility-info">
                                        <h4>Luxury Spa</h4>
                                        <p>
                                            Tranquil sanctuary offering
                                            therapeutic treatments, rejuvenating
                                            massages, and holistic wellness
                                            experiences. Escape the everyday
                                            stress in our serene environment.
                                        </p>
                                        <div className="facility-features">
                                            <span>
                                                <i className="bi bi-check-circle"></i>{" "}
                                    ...
                                    <div className="testimonial-card">
                                        ...
                                        <div className="testimonial-content">
                                            <p>
                                                ...
                                                dapibus leo. Sed non mauris
                                                vitae erat consequat auctor eu
                                                in elit.
                                            </p>
                                        </div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                ...
                                >
                                    ...
                                    <div className="offer-content">
                                        ...
                                        <p>
                                            Escape the ordinary with our
                                            exclusive weekend package. Includes
                                            complimentary breakfast and late
                                            checkout until 2 PM.
                                        </p>
                                ...
                                >
                                    ...
                                    <div className="offer-content">
                                        ...
                                        <p>
                                            ...
                                            significant savings. Perfect for
                                            business travelers and extended
                                            vacations with premium amenities.
                                        </p>
                                        <div className="offer-details">
                                            <div className="price-info">
                                                <span className="original-price">
                            ...
                            <div className="col-lg-4 col-md-6">
                                ...
                                >
                                    ...
                                    <div className="offer-content">
                                        ...
                                        <p>
                                            Plan ahead and save more! Book your
                                            stay 30 days in advance and enjoy
                                            exclusive rates with free
                            ...
                            >
                                <div className="content">
                                    ...
                                    <p>
                                        ...
                                        and sophistication at our premium hotel.
                                        From elegantly appointed rooms to
                                        world-className amenities, every detail
                                        is crafted to exceed your expectations.
                                        Book your extraordinary stay today and
                                    ...
                                    <ul className="features-list">
                                        ...
                                        <li>
                                            <i className="bi bi-check-circle"></i>{" "}
                                            State-of-the-art spa and fitness
                                            center
                                        </li>
                                        <li>
                                            <i className="bi bi-check-circle"></i>{" "}
                                            Prime location with stunning city
                                            views
                                        </li>
                                    </ul>
                            ...
                            <div className="col-lg-4 col-md-6">
                                ...
                                >
                                    ...
                                    <div className="event-content">
                                        ...
                                        <p>
                                            Mollit anim id est laborum at vero
